...
| REQ-05 | Rundenbasierte Steuerung (Host bestimmt, wer dran ist, und aktiviert Client) | SPEC Goal 2 | Complete |
| REQ-06 | Wetteinsatz-Auswahl auf Client (Pasch, Trasch etc.) oder Überspringen | SPEC Goal 2 | Complete |
| REQ-07 | Würfel-Trigger (Client sendet Roll-Event via WebRTC an Host) | SPEC Goal 2 | Complete |
...
| REQ-23 | Lobby-Editor UI zur Bearbeitung der 10 Strafeinträge pro Einsatz-Set | ROADMAP Must-Haves | Complete |
| REQ-24 | Synchronisation bearbeiteter Strafeinträge an verbundene Controller | ROADMAP Must-Haves | Complete |
| REQ-25 | Reset-Button zum Zurücksetzen bearbeiteter Werte auf Defaults | ROADMAP Nice-to-Haves | Complete |
| REQ-26 | Persistierung modifizierter Einsatz-Sets im `localStorage` des Hosts | ROADMAP Must-Haves | Complete |
| REQ-27 | Mobiles UI-Layout für das Host Dashboard (kompakte Würfel, Nav-Tabs, einklappbarer QR-Bereich) | ROADMAP Must-Haves | Complete |
| REQ-28 | Host-Spieler-Modus (Lobby-Registrierung, Rundenaktivierung, lokale Pause) | ROADMAP Must-Haves | Complete |
