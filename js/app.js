...
const STAKE_SETS = {
    ...
    'spanien': ['Standard-Einsatz (Cortado trinken)', '¡Salud! rufen (Pasch)', 'Siesta machen (Doppelpasch)', 'San Francisco kaufen (Full House)', 'Flamenco tanzen (Straße)', 'Horchata trinken (Quadrasch)', 'Rechnung zahlen (Quadrasch)', '¡Adiós! Geh heim (Quintasch)', 'Nie wieder Tapas essen! (Quintasch)'],
